...
@section('container')
    <h1>Edit Karyawan: {{ $karyawan->nama_karyawan }}</h1>
    ...
    <div class="form-group">
        <form action="/karyawan" method="post">
            ...
            <div class="form-group">
                ...
                <input class= "form-control" type="text" name="nama_karyawan" id="nama_karyawan" required autofocus value="{{ old('nama_karyawan', $karyawan->nama_karyawan) }}">
            ...
            <div class="container-input form-group">
                ...
                <input class="form-control form-control-sm" type="text" name="username" id="username" required value="{{ old('username', $karyawan->username) }}" required>
